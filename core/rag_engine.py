...
# Context window settings (for common models)
DEFAULT_CONTEXT_WINDOW = 4096  # Default to 4K (safe for most models)
CONTEXT_RESERVE_PERCENT = 0.70  # Use max 70% of context window for RAG
MIN_CONTEXT_TOKENS = 500  # Minimum tokens to reserve for response

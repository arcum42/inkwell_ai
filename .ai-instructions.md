# Inkwell AI - Coding Standards & LLM Instructions
...
### Debug Output
- Use `print(f"DEBUG: ...")` for development (consider logging module later)
- Include context: operation, paths, counts
- Example: `print(f"DEBUG: Querying RAG for: {message}")`

### Error Messages
- User-facing: concise, actionable (e.g., "File not found: example.md")
- Console: detailed with stack traces and context

### Testing
- Manual testing focus for now
- Test core logic (ProjectManager, RAGEngine) separately when possible
- Validate file operations in temporary directories
